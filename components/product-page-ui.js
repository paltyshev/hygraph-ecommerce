    ...
    <div className="px-4">
      <div className="lg:flex lg:space-x-4">
        ...
        <div className="md:py-3 lg:w-1/2">
            ...
            <div className="px-3 mb-6">
              ...
              <div className="flex space-x-2">
                ...
                <div className="flex-auto">
                  <Button color='primary' size='lg' fullWidth='true' onClick={addToCart}>
                    <svg
                      className="mr-1"
                      width="25"
                      height="24"
          ...
          <div className="lg:hidden absolute left-0 w-full h-6 bg-primary-200"></div>
        </div>
      </div>
      ...
      <div className="lg:hidden absolute left-0 w-full h-6 bg-primary-200"></div>
      <div className="mb-14 md:hidden px-4 z-10 fixed inset-x-0 bottom-0 pt-2 bg-background">
        <Button color='primary' size='lg' fullWidth='true'
          onClick={addToCart}
          className="font-medium items-center justify-center text-sm"
        >
          В корзину
          <br />
